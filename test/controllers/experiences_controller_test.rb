...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { description: @experience.description, end: @experience.end, start: @experience.start, title: @experience.title }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { description: @experience.description, end: @experience.end, start: @experience.start, title: @experience.title }
    assert_redirected_to experience_path(assigns(:experience))
  end
